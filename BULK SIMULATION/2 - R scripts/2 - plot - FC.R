...
directories = c("de2000_ds0_dr2000",
                "de2000_ds0_dr2000_logFC_6",
                "de2000_ds0_dr2000_logFC_9")

directories_results = c("DR + DGE",
                        "log2FC_6",
                        "log2FC_9")
...
GG_ROC_topN = ggpubr::ggarrange(ROC_type[[1]] + labs(subtitle = "FC 3") + my_theme,
                                ROC_type[[2]] + ylab("") + labs(subtitle = "FC 6") + my_theme,
                                ROC_type[[3]] + ylab("") + labs(subtitle = "FC 9") + my_theme,
...
ggsave(filename = paste0('DGE_FC_bulk.pdf'),
       plot = GG_ROC_topN,
       device = "pdf",
       path = save_path,
       width = 30,
